...
import (
	...
	ebpfhelpers "github.com/levigross/ebpf-helpers"
...
func run(args []string) error {
	...
	// We are just going to run this locally
	...
	return ebpfhelpers.WriteFormatted(output, w)
}
...
func generateTypes(spec *btf.Spec) ([]byte, error) {
	...
	gf := &btf.GoFormatter{
		...
		Identifier: ebpfhelpers.Identifier,
	...
	w.WriteString(`// Code generated by ebpf-helpers/cmd/gentypes; DO NOT EDIT.
